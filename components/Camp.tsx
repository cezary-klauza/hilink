...
const CampSite = ({
  ...
  return (
    <div
      ref={reference}
      className={`h-full w-full min-w-[600px] lg:min-w-[1100px] ${backgroundImage} bg-cover bg-no-repeat bg-center lg:rounded-r-5xl 2xl:rounded-5xl`}
    >
      ...
      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
        ...
        >
          <h2 className="regular-24 md:regular-32 2xl:regular-64 text-white">
            <strong className="drop-shadow-sm">Feeling Lost</strong> And Not
            Knowing The Way?
          </h2>
